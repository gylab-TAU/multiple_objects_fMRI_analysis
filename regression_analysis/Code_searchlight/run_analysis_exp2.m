...
subj = dir ('/data/libi/MRI_data/Face_Object_Integration/data_mat_files_m/*.mat');

load_settings_file_list = {'./load_settings_params_searchlight_exp2_FO.m'
                            './load_settings_params_searchlight_exp2_FB.m'};
