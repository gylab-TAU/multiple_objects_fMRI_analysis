function [ settings, params ] = load_settings_params_searchlight_exp2_FO(settings, params )
    
%% paths

settings.path_Data = '/data/libi/MRI_data/Face_Object_Integration/data_mat_files_m';
settings.path_Results = './Results/searchlight_exp2_FO';
settings.path_Figures = './Figures/searchlight_exp2_FO';
...
settings.data.data_design = 'FO_model';
...
settings.cond_names = {'Face' 'Object' 'IntegratedFO'};
settings.A_cond_name = 'Face'; % first single, weight is alpha
settings.B_cond_name = 'Object'; % second cond, weight is beta
settings.C_cond_name = 'IntegratedFO'; % combined cond
...
settings.masks(2).header = 'Brain_activation_mask_FO_model';
