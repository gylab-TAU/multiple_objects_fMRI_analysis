function [ settings, params ] = load_settings_params_exp2_FO(settings, params )
    
%% paths

settings.path_Data = '/data/libi/MRI_data/Face_Object_Integration/data_mat_files_m/';
settings.path_Results = './Results/exp2_FO';
settings.path_Figures = './Figures/exp2_FO';
