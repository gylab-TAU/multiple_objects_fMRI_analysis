function [data] = load_data(settings)
...
data.ind.voxel_inds = subj_data.data(:,var_ind);
...
filter_data_header = [settings.data.data_type '_' settings.data.data_design '_.*Sn.*' ];
...
switch settings.data.sample_type
    ...
    case 'ROIs_all_else_excluded'
        ...
        for roi_itr = 1: length(settings.rois.names)
            ...
            roi_mask = subj_data.data(:,filter_roi_mask_ind);
            ...
            t_val = subj_data.data(:,filter_roi_t_val_ind);
